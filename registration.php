                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" type="tel" maxlength="10" name="phone" id="example-tel-input-3" placeholder="Phone"> <small class="form-text text-muted">We"ll never share your mobile number with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address:</h5>
                            <p>Government Polytechnic, Osmanabad</p>
