            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            <li><a href="#">Akashwani</a> </li>
                            <li><a href="#">Beed By Paas</a> </li>
                            <li><a href="#">Darga Base</a> </li>
                            <li><a href="#">Railway station</a> </li>
                            <li><a href="#">Satara Parisar</a> </li>
                            <li><a href="#">Prozone Mall</a> </li>
                            <li><a href="#">Walunj</a> </li>
                            <li><a href="#">Canott</a> </li>
                            <li><a href="#">Cigma Hospital</a> </li>
                            <li><a href="#">Aditya nagar</a> </li>
                        </ul>
                    </div>
                </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <h5>Call us at: <a href="tel:+91 7620318052">+91 7620318052</a></h5></div>
